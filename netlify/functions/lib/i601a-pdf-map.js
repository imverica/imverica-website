...
function sexFields(v){const s=clean(v,40).toLowerCase();
  if(/^m|male/.test(s))return{"Pt1Line10_Sex[0]":true,"Pt1Line10_Sex[1]":false};
  if(/^f|female/.test(s))return{"Pt1Line10_Sex[0]":false,"Pt1Line10_Sex[1]":true};
  return {};}
...
function i_601aFieldValues(payload={}) {
  ...
  v["Pt1Line2_SSN[0]"] = digits(a.ssn || a.social_security_number, 9);
  v["Pt1Line3_USCISELISAcctNumber[0]"] = digits(a.uscis_online_account_number, 12);
  v["Pt1Line13_CountryOfBirth[0]"]  = clean(a.country_of_birth, 60);
  ...
  v["Pt7Line6_NameOfLanguage[0]"]   = clean(a.interpreter_language, 40);
...
module.exports = { i_601aFieldValues };