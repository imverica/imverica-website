...
function i_918FieldValues(payload={}) {
  ...
  v["P4_Line2_DateOfBirth[0]"] = dateMdY(a.date_of_birth || a.dob || '');
  ...
  v["P4_Line3_CountryOfBirth[0]"]  = clean(a.country_of_birth, 60);
  v["P1_Line12_CountryOfCitizenship[0]"]  = clean(a.country_of_citizenship, 60);
