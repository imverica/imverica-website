...
function n_648FieldValues(payload={}) {
  ...
  v["Pt1Line5_DateofBirth[0]"] = dateMdY(a.date_of_birth || a.dob || '');
  v["Pt1Line3_AlienNumber[0]"] = digits(a.alien_number || a.a_number, 9);
  v["Pt2Line2_StreetNumberName[0]"] = clean(a.mailing_address_line1 || a.current_address_line1 || a.address_line1, 80);
  v["Pt2Line2_AptSteFlrNumber[0]"] = clean(a.mailing_address_line2 || a.address_unit, 10).replace(/^(?:apt|ste|fl|unit|#)\s*\.?\s*/i,'').slice(0,6);
  Object.assign(v, unitRadio("Pt2Line2_Unit", a.mailing_address_line2 || a.address_unit)); // Apt/Ste/Flr selector
  v["Pt2Line2_CityOrTown[0]"] = clean(a.mailing_city || a.city, 60);
  v["Pt2Line2_State[0]"] = stateCode(a.mailing_state || a.state || '');
...
module.exports = { n_648FieldValues };