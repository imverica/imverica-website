...
function i_800aFieldValues(payload={}) {
  ...
  v["P3_Line6_Email[0]"]  = clean(a.email_address || a.email || c.email, 120);
  v["P13_DateofSignature[1]"] = dateMdY(a.applicant_signature_date);
...
module.exports = { i_800aFieldValues };