...
function i_690FieldValues(payload={}) {
  ...
  v["Pt1Line6D_DateOfBirth[0]"] = dateMdY(a.date_of_birth || a.dob || '');
  v["Pt2Line6D_AlienNumber[0]"] = digits(a.alien_number || a.a_number, 9);
  v["Pt1Line10_SSN[0]"] = digits(a.ssn || a.social_security_number, 9);
  v["Pt1Line9_USCISOnlineAcctNumber[0]"] = digits(a.uscis_online_account_number, 12);
  v["Pt1Line5_CityTownOfBirth[0]"] = clean(a.city_of_birth || a.place_of_birth_city, 60);
  v["Pt1Line6_CountryOfBirth[0]"]  = clean(a.country_of_birth, 60);
  v["Pt1Line4_StreetNumberName[0]"] = clean(a.mailing_address_line1 || a.current_address_line1 || a.address_line1, 80);
  v["Pt1Line4_AptSteFlrNumber[0]"] = unitNumber(a.mailing_address_line2 || a.address_unit);
  Object.assign(v, unitRadio("Pt1Line4_Unit", a.mailing_address_line2 || a.address_unit)); // Apt/Ste/Flr selector
  v["Pt1Line4_CityOrTown[0]"] = clean(a.mailing_city || a.city, 60);
  v["Pt1Line4_State[0]"] = stateCode(a.mailing_state || a.state || '');
  v["Pt1Line4_ZipCode[0]"]   = digits(a.mailing_zip || a.zip_code, 10);
  v["Pt5Line3_PrepDaytimeTelePhoneNumber[0]"]  = usPhone(a.daytime_phone || a.phone || c.phone);
  v["Pt4Line4_InterpreterMobileTelephoneNumber[0]"] = usPhone(a.mobile_phone || a.daytime_phone || c.phone);
  v["Pt4Line5_EmailAddress[0]"]  = clean(a.email_address || a.email || c.email, 120);
  v["Pt5Line6_DateofSignature[0]"] = dateMdY(a.applicant_signature_date);
...
module.exports = { i_690FieldValues };