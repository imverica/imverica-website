...
function i_191FieldValues(payload={}) {
  ...
  v["P1_Line6_DateOfBirth[0]"] = dateMdY(a.date_of_birth || a.dob || '');
  v["P6_Line50_AlienNumber[0]"] = digits(a.alien_number || a.a_number, 9);
  v["P1_Line8_USCISOnlineAcctNumber[0]"] = digits(a.uscis_online_account_number, 12);
  v["Pt6Line54_CountryOfBirth[0]"]  = clean(a.country_of_birth, 60);
  v["Pt6Line55_CountryOfCitizenship[0]"]  = clean(a.country_of_citizenship, 60);
  v["Line15_Passport[0]"] = clean(a.passport_number, 20);
  v["Pt1Line8_StreetNumberName[0]"] = clean(a.mailing_address_line1 || a.current_address_line1 || a.address_line1, 80);
  v["Pt11Line3_PrepDaytimeTelePhoneNumber[0]"]  = usPhone(a.daytime_phone || a.phone || c.phone);
  v["Pt3Line5_MobileTelephoneNumber3[0]"] = usPhone(a.mobile_phone || a.daytime_phone || c.phone);
  v["Pt10Line5_InterpreterEmailAddress[0]"]  = clean(a.email_address || a.email || c.email, 120);
  v["Pt11Line6_DateofSignature[0]"] = dateMdY(a.applicant_signature_date);
  ...
  v["Pt11Line1_PreparerGivenName[0]"]  = clean(a.preparer_given_name, 60);

  return Object.fromEntries(Object.entries(v).filter(([,val])=>val!==undefined&&val!==null&&val!==''));
}

module.exports = { i_191FieldValues };