...
function g_845_supplementFieldValues(payload={}) {
  ...
  v["P1_Line11a_DaytimeTelephone[0]"]  = usPhone(a.daytime_phone || a.phone || c.phone);

  return Object.fromEntries(Object.entries(v).filter(([,val])=>val!==undefined&&val!==null&&val!==''));
}

module.exports = { g_845_supplementFieldValues };