...
function n_336FieldValues(payload={}) {
  ...
  v["Pt7Line4_PrepDaytimeTelePhoneNumber[0]"]  = usPhone(a.daytime_phone || a.phone || c.phone);
  v["Pt3Line5_MobileTelephoneNumber3[0]"] = usPhone(a.mobile_phone || a.daytime_phone || c.phone);
  v["Pt7Line6_EmailAddress[0]"]  = clean(a.email_address || a.email || c.email, 120);
  v["Pt5Line8_DateofSignature[0]"] = dateMdY(a.applicant_signature_date);
...
module.exports = { n_336FieldValues };