...
function i_600aFieldValues(payload={}) {
  ...
  v["Pt1Line26_AptSteFlrNumber[0]"] = unitNumber(a.mailing_address_line2 || a.address_unit);
  Object.assign(v, unitRadio("Pt1Line26_Unit", a.mailing_address_line2 || a.address_unit)); // Apt/Ste/Flr selector
