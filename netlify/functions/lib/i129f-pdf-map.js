...
function i_129fFieldValues(payload={}) {
  ...
  Object.assign(v, unitRadio("Pt2Line60_Unit", a.mailing_address_line2 || a.address_unit)); // Apt/Ste/Flr selector
  ...
  v["Pt7Line6_DateofSignature[0]"] = dateMdY(a.applicant_signature_date);
