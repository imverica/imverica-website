...
function i_290bFieldValues(payload={}) {
  ...
  v["P4_Line5_Email[0]"]  = clean(a.email_address || a.email || c.email, 120);
  v["P4_Line6b_DateofSignature[0]"] = dateMdY(a.applicant_signature_date);
...
module.exports = { i_290bFieldValues };