...
function i_821dFieldValues(payload={}) {
  ...
  // Interpreter fields use ONLY the interpreter's own data — never the applicant's.
  v["P6_Line3a_Street[0]"] = clean(a.interpreter_address_line1, 80);
  v["P6_Line3b_Number[0]"] = addressLine2(a.interpreter_address_line2);
  Object.assign(v, unitRadio("P6_Line3b_Unit", a.interpreter_address_line2));
  v["P6_Line3c_City[0]"] = clean(a.interpreter_city, 60);
  v["P6_Line3d_State[0]"] = stateCode(a.interpreter_state || '');
  v["P6_Line3e_ZipCode[0]"] = digits(a.interpreter_zip, 10);
  v["P6_Line3h_Country[0]"] = clean(a.interpreter_country, 60);
  v["P6_Line4_DayPhone[0]"] = usPhone(a.interpreter_phone);
  v["P6_Line5_Email[0]"] = clean(a.interpreter_email, 120);
  ...
  v["P7_Line3a_Street[0]"] = clean(a.preparer_address_line1, 80);
  v["P7_Line3b_Number[0]"] = addressLine2(a.preparer_address_line2);
  Object.assign(v, unitRadio("P7_Line3b_Unit", a.preparer_address_line2));
  v["P7_Line3c_City[0]"] = clean(a.preparer_city, 60);
  v["P7_Line3d_State[0]"] = stateCode(a.preparer_state || '');
  v["P7_Line3e_ZipCode[0]"] = digits(a.preparer_zip, 10);
  v["P7_Line3h_Country[0]"] = clean(a.preparer_country, 60);
  v["P7_Line4_DayPhone[0]"] = usPhone(a.preparer_phone);
  v["P7_Line5_MobilePhone[0]"] = usPhone(a.preparer_mobile_phone || a.mobile_phone);
  v["P7_Line6_Email[0]"]  = clean(a.preparer_email, 120);
