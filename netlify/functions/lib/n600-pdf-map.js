...
function sexFields(v){const s=clean(v,40).toLowerCase();
  if(/^m|male/.test(s))return{"P2_Line9_Gender[0]":true,"P2_Line9_Gender[1]":false};
  if(/^f|female/.test(s))return{"P2_Line9_Gender[0]":false,"P2_Line9_Gender[1]":true};
  return {};}

function maritalFields(v){const s=clean(v,80).toLowerCase();
  const all={"P5_Line8B_MaritalStatus[0]":false,"P5_Line8B_MaritalStatus[1]":false,"P5_Line8B_MaritalStatus[2]":false,"P5_Line8B_MaritalStatus[3]":false,"P5_Line8B_MaritalStatus[4]":false,"P5_Line8B_MaritalStatus[5]":false,"P5_Line8B_MaritalStatus[6]":false,"P4_Line8B_MaritalStatus[0]":false,"P4_Line8B_MaritalStatus[1]":false,"P4_Line8B_MaritalStatus[2]":false,"P4_Line8B_MaritalStatus[3]":false,"P4_Line8B_MaritalStatus[4]":false,"P4_Line8B_MaritalStatus[5]":false,"P4_Line8B_MaritalStatus[6]":false,"P2_Line12_MaritalStatus[0]":false,"P2_Line12_MaritalStatus[1]":false,"P2_Line12_MaritalStatus[2]":false,"P2_Line12_MaritalStatus[3]":false,"P2_Line12_MaritalStatus[4]":false,"P2_Line12_MaritalStatus[5]":false,"P2_Line12_MaritalStatus[6]":false};
  if(/married|spouse|брак/.test(s))return{...all,"P2_Line12_MaritalStatus[3]":true};
  if(/single|never|холост/.test(s))return{...all,"P2_Line12_MaritalStatus[1]":true};
  if(/divorc|развед/.test(s))return{...all,"P2_Line12_MaritalStatus[0]":true};
  if(/widow|вдов/.test(s))return{...all,"P2_Line12_MaritalStatus[2]":true};
  if(/annul/.test(s))return{...all,"P2_Line12_MaritalStatus[6]":true};
  if(/separat/.test(s))return{...all,"P2_Line12_MaritalStatus[4]":true};
  return {};}
...
function n_600FieldValues(payload={}) {
  ...
  v["Pt1Line1_MiddleName[1]"] = clean(a.applicant_middle_name || a.middle_name || '', 60);
  v["P5_Line9B_DateofBirth[0]"] = dateMdY(a.date_of_birth || a.dob || '');
  v["Line1_AlienNumber[0]"] = digits(a.alien_number || a.a_number, 9);
  { const an = digits(a.alien_number || a.a_number, 9); if(an) {
    v["Line1_AlienNumber[15]"] = an;
    v["Line1_AlienNumber[14]"] = an;
    ...
    v["Line1_AlienNumber[16]"] = an;
  }}
  v["P1_Line4_SSN[0]"] = digits(a.ssn || a.social_security_number, 9);
  v["P1_Line5_USCISELISAcctNumber[0]"] = digits(a.uscis_online_account_number, 12);
  v["P5_Line2_CountryOfBirth[0]"]  = clean(a.country_of_birth, 60);
  v["Pt2Line14B_PassportNumber[0]"] = clean(a.passport_number, 20);
  ...
  v["P10_Line1_PreparerGivenName[0]"]  = clean(a.preparer_given_name, 60);

  return Object.fromEntries(Object.entries(v).filter(([,val])=>val!==undefined&&val!==null&&val!==''));
}

module.exports = { n_600FieldValues };